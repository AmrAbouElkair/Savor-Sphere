export const navSidebar = [
  { id: "1", text: "Orders", icon: "truck-fast" },
  { id: "2", text: "Favourites", icon: "heart" },
  { id: "3", text: "Wallet", icon: "wallet" },
  { id: "4", text: "Help", icon: "circle-question" },
  { id: "5", text: "Promotions", icon: "clipboard-check" },
  { id: "6", text: "Best One", icon: "circle-arrow-down" },
  { id: "7", text: "Invite Friends", icon: "user-group" },
];
...
export const menu: {
  ...
  {
    id: "1",
    header: "Sun's Out, BOGO's Out",
    desc: "Through 8/26",
    img: "https://images.unsplash.com/photo-1514186073652-b140ce52bcd3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1742&q=80",
    alt: "eggs",
  },
  {
    id: "2",
    ...
    desc: "Added Daily",
    img: "https://images.unsplash.com/photo-1432139555190-58524dae6a55?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1752&q=80",
    alt: "meat",
  },
  {
    id: "3",
    header: "We Deliver Desserts Too",
    desc: "Tasty Treats",
    img: "https://images.unsplash.com/photo-1675670510679-3b0e18baa094?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1955&q=80S",
    alt: "desert",
  },
];
